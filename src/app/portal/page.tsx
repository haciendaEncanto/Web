...
export default async function PortalDashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      {booking ? (
        <>
          {/* Fila principal: cuenta regresiva + info del evento */}
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
            {/* Cuenta regresiva — ocupa 3 cols */}
            ...
            {/* Detalles del evento — ocupa 2 cols */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <QuickLink
              ...
              icon={FileText}
              title="Documentos"
              description="Contratos y archivos"
            />
            <QuickLink
              href="/portal/pagos"
              icon={CreditCard}
            ...
            <QuickLink
              ...
              icon={MessageSquare}
              title="Mensajes"
              description="Comunícate con el equipo"
            />
          </div>

          {/* CTA orden de servicio si no está aprobada */}
          {!booking.service_order_approved && (
            <div className="bg-dorado/8 border border-dorado/20 rounded-xl p-5 flex items-center justify-between gap-4">
              <div>
                ...
                <p className="text-[0.78rem] text-gris mt-0.5">
                  Revisa los detalles de tu evento y aprueba cuando estés de
                  acuerdo
                </p>
              </div>
              <Link
        ...
        /* Estado vacío — sin booking activo */
  ...
  return (
    <div className="flex items-start gap-3">
      ...
      <div className="min-w-0">
        <p className="text-[0.68rem] text-gris uppercase tracking-wide">
          {label}
        </p>
